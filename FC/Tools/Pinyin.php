...
class Pinyin
{
    ...
    public static function get($str, $charset = 'utf-8', $first = 0)
    {
        $str = trim($str);
        if ($charset != 'gbk' && $charset != 'gb2312') $str = iconv($charset, 'gbk//IGNORE', $str);
        $ret = '';
    ...
    public static function initial($str, $charset = 'utf-8', $first = 0)
    {
